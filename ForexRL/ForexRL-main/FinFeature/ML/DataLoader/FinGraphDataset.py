...
import numpy as np
from FinFeature.ML.DataLoader.FxGraph import StaticFxGraph
...
class GraphDataset:
    ...
    def data_loader(self, batch_size=1):
        all_data = []
...
# g_data = GraphDataset(currencies, symbols, fin_features)
# print(g_data.number_tick)
#
# print(g_data.num_node_feature)
#
# print(g_data.number_edges_feature)
#
# print(g_data.number_nodes)
# print(g_data.number_edges)
